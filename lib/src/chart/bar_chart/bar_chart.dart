...
class _BarChartState extends AnimatedWidgetBaseState<BarChart> {
  ...
  Widget build(BuildContext context) {
    final showingData = _getData(widget.data);
  ...
  BarChartData _getData(BarChartData barChartData) {
    final barTouchData = barChartData.barTouchData;
  ...
  void forEachTween(TweenVisitor<dynamic> visitor) {
    ...
    // _defaultBarChartDataTween = visitor(
    //   _barChartDataTween,
    //   widget.defaultData,
    //   (dynamic value) => BarChartDataTween(
    //     begin: value as BarChartData,
    //     end: widget.defaultData,
    //   ),
    // ) as BarChartDataTween?;
  }
}
